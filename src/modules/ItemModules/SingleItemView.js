        ...
        <div className="row mt-5">
          ...
          <div className="col-lg-6">
            <div className="row mb-2">
              <div className="col-lg-10 col-md-10 col-sm-12"><h1>{this.props.singleItem.name}</h1></div>
              <hr />
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Brand</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.brand}</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">RAM</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.ram} GB</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Storage</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.storage} GB</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Stock</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.stock}</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Seller</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.sellarName}</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Price</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.price}</div>
            </div>
            <div className="row mb-2">
              <div className="col-lg-3 col-md-3 col-sm-3 text-muted">Description</div>
              <div className="col-lg-8 col-md-8 col-sm-8 text-left">{this.props.singleItem.description}</div>
            </div>
            <div className="row mb-2">
